    ...
    setup(__props, { emit }) {
        ...
        return (_ctx, _cache) => {
            return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
                vue.createTextVNode(vue.toDisplayString(vue.unref(moment)(new Date).format("dddd MM YYYY")) + " ", 1 /* TEXT */),
                vue.createVNode(vue.unref(Field), {
                    name: "email",
                    class: "form-control",
                    type: "email"
                }),
...
const _hoisted_1 = /*#__PURE__*/vue.createElementVNode("textarea", { class: "form-control" }, null, -1 /* HOISTED */);

function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
    vue.createElementVNode("label", null, vue.toDisplayString(_ctx.labelText), 1 /* TEXT */),
    _hoisted_1
  ], 64 /* STABLE_FRAGMENT */))
}
...
exports.RogoButton = script$2;
exports.RogoInputText = script$1;
exports.RogoTextArea = script;
